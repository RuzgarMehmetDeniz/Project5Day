        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeagueIcon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchWeeks", x => x.MatchWeekId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatchId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstHalfScore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecondHalfScore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SpectatorCount = table.Column<int>(type: "int", nullable: false),
